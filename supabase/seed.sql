...
from viaje v
cross join (values
  ('Ana Pérez',       'Brújula mochilera',   'Santa Rosa', 'Pago Móvil', 10),  -- Completo
  ('Luis Gómez',      'Senderos del alma',   'El Cafetal', 'Efectivo',    5),  -- Abonado
  ('María Rodríguez', 'Brújula mochilera',   'Santa Rosa', 'Pago Móvil',  0),  -- Pendiente
  ('Carlos Díaz',     'Destino 100% activo', 'Chacao',     'Efectivo',   10),  -- Completo
  ('Elena Torres',    'Senderos del alma',   'El Cafetal', 'Pago Móvil',  3)   -- Abonado
